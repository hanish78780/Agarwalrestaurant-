document.addEventListener('DOMContentLoaded', function () {
    ...
    filterButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            menuItems.forEach(item => {
                ...
                // Use CSS class for visibility instead of direct style manipulation
    ...
    function handleOrderNowClick(event) {
        ...
        const priceValue = card.querySelector('.price');
        const img = card.querySelector('img');
        const ratingValue = card.querySelector('.rating');

        if (!title || !text || !priceValue || !img || !ratingValue) {
        ...
        const params = new URLSearchParams({
            ...
            price: priceValue.textContent.trim(),
            img: img.src,
            rating: ratingValue.textContent.trim()
        }).toString();

        try {
            window.location.href = `order.html?${params}`;
        } catch (error) {
            console.error('Error redirecting to order page:', error);
        }
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateCartBadge() {
        ...
        if (cartBadge) {
            cartBadge.textContent = cartCount; // Update badge with the number of items
        }
    }
    ...
    document.querySelectorAll('.cart-btn').forEach((button) => {
        button.addEventListener('click', function () {
            ...
            const itemTitle = menuItem.querySelector('.card-title').innerText;
            const itemPrice = parseFloat(menuItem.querySelector('.price').innerText.replace('Rs.', ''));
            const itemImage = menuItem.querySelector('img.card-img-top').src;
...
const menuItems = [
    ...
    { name: "Iced Coffee", price: "Rs.70.00", category: "beverages", rating: "4.9", imageUrl: "https://t3.ftcdn.net/jpg/03/16/01/48/240_F_316014817_EC1KN7mAD86ALYhhwGUUeSsQoJIVMtfQ.jpg", description: "Chilled coffee served over ice for a refreshing taste."},
    {
        ...
        category: "beverages",
        rating: "4.9",
        imageUrl: "https://t4.ftcdn.net/jpg/01/19/83/87/240_F_119838786_qm7XvDrDsCh2COxv8Wja5akq7Vzn7rCo.jpg",
    ...
    },
    {
        ...
        category: "beverages",
        rating: "4.6",
        imageUrl: "https://t3.ftcdn.net/jpg/02/60/17/24/240_F_260172428_nFYpkCiYQDFeR4UcRXoRaby3E5c8zhud.jpg",
    ...
    },
    {
        ...
        category: "beverages",
        rating: "4.9",
        imageUrl: "https://t4.ftcdn.net/jpg/01/87/21/31/240_F_187213110_p07ufUC42zVlcaijXRuFFYB4MKsWLgq1.jpg",
        description: "Freshly squeezed orange juice with a tangy flavor."
    },
    {
        name: "Smoothie",
        price: "Rs.90.00",
        category: "beverages",
        rating: "4.9",
        imageUrl: "https://t4.ftcdn.net/jpg/01/13/31/51/240_F_113315160_nzzPgtIF4lAehS6l3du3JkHCwGr7eBHH.jpg",
        description: "Blended fruit smoothie with a variety of flavors."
    },
    {
        name: "Burger & Fries",
        price: "Rs.250.00",
        category: "combos",
        rating: "4.9",
        imageUrl: "https://t3.ftcdn.net/jpg/02/44/61/14/240_F_244611436_4WKrV3YAOBo0LKe9S7hoXv55aDmgwvwr.jpg",
        description: "A delicious burger with crispy fries. Perfect for a meal."
    },
    {
        name: "Pizza & Soft Drink",
        price: "Rs.350.00",
        category: "combos",
        rating: "4.9",
        imageUrl: "https://t3.ftcdn.net/jpg/07/74/86/96/240_F_774869657_DINtsrc9lyT05w0mr6aPY3TdxnG7EaLF.jpg",
        description: "Enjoy a classic pizza with a refreshing soft drink."
    },
    {
        name: "Chicken Wings & Salad",
        price: "Rs.300.00",
        category: "combos",
        rating: "4.9",
        imageUrl: "https://t4.ftcdn.net/jpg/01/85/57/71/240_F_185577147_BQI8B7BK60WJ1xpOJAustEhs84BuaMTb.jpg",
        description: "Spicy chicken wings paired with a fresh salad."
    },
    {
        name: "Sandwich & Soup",
        price: "Rs.280.00",
        category: "combos",
        rating: "4.8",
        imageUrl: "https://t3.ftcdn.net/jpg/08/15/02/72/240_F_815027254_VKxW4dvs4v1aQVBpeSmx70fdPZunj9pJ.jpg",
        description: "A hearty sandwich with a warm bowl of soup."
    },
    {
        ...
        category: "combos",
        rating: "4.3",
        imageUrl: "https://t4.ftcdn.net/jpg/06/18/49/71/240_F_618497137_lRl6KfzZiSKggTwtFmR2NJGUqSJ2CSJz.jpg",
        description: "Delicious pasta served with garlic bread."
    },
    {
        name: "Sushi & Miso Soup",
        price: "Rs.350.00",
        category: "combos",
        rating: "4.7",
        imageUrl: "https://t4.ftcdn.net/jpg/09/17/18/75/240_F_917187562_BsACFCTMrfzM2pYkicl0ogJha8yzkfnx.jpg",
        description: "Fresh sushi rolls paired with a bowl of savory miso soup."
    },
    {
        name: "Burrito & Nachos",
        price: "Rs.350.00",
        category: "combos",
        rating: "4.4",
        imageUrl: "https://t3.ftcdn.net/jpg/08/58/57/50/240_F_858575001_4J1JITghebGkjqljIlnD3umuOBC0uQcH.jpg",
        description: "A flavorful burrito with crunchy nachos."
    },
    {
        name: "Falafel Wrap & Hummus",
        price: "Rs.270.00",
        category: "combos",
        rating: "4.2",
        imageUrl: "https://t3.ftcdn.net/jpg/08/21/46/98/240_F_821469809_LrbP0PdZRJknS67pqaFJKW1IDiWzT8cx.jpg",
        description: "A savory falafel wrap served with a side of hummus."
    },
    {
        name: "Chicken Tenders & Coleslaw",
        price: "Rs.290.00",
        category: "combos",
        rating: "4.6",
        imageUrl: "https://t3.ftcdn.net/jpg/09/58/60/48/240_F_958604832_RZOetN1N9HtWfARPc6xp8mmMCCmrQWGA.jpg",
        description: "Crispy chicken tenders with a side of coleslaw."
    },
    {
        name: "Veggie Wrap & Fruit Juice",
        price: "Rs.260.00",
        category: "combos",
        rating: "4.9",
        imageUrl: "https://t3.ftcdn.net/jpg/09/03/37/60/240_F_903376004_ju23VXINE2JUmtJGQ9MGaqicpEhvmnRB.jpg",
        description: "A healthy veggie wrap accompanied by fresh fruit juice."
    },
    {
        name: "Grilled Cheese Sandwich & Tomato Soup",
        price: "Rs.290.00",
        category: "combos",
        rating: "4.8",
        imageUrl: "https://t3.ftcdn.net/jpg/09/07/26/20/240_F_907262013_j10opqDjwoK1xYaxfjAHoYtCMmrwxYiA.jpg",
        description: "Classic grilled cheese sandwich served with a warm bowl of tomato soup."
    },
    {
        name: "BBQ Ribs & Cornbread",
        price: "Rs.400.00",
        category: "combos",
        rating: "4.5",
        imageUrl: "https://t3.ftcdn.net/jpg/08/18/83/26/240_F_818832669_BKZNNGfUA61x4EUhmZgjohsGktyMXDOm.jpg",
        description: "Tender BBQ ribs served with a side of cornbread for a hearty meal."
    }
];
// Sample menu items
...
document.querySelector('.row.g-4').innerHTML = generateMenuHTML(items);
}
